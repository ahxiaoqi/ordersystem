...
public class BuyMoreController {
    ...
    // 初始化评论墙
    @ResponseBody
    @RequestMapping(value = "innit_buyMore_commentBox_Rand", method = RequestMethod.POST)
    public List<Comment> innitCommentBoxRand(@RequestParam(value = "num", defaultValue = "6", required = false) Integer num) {
        return commentService.innitCommentBoxRand(num);
    }

    ...
    FileInput.prototype = {
        ...
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                ...
                // content = '<button id="' + self.uploadButtonName + '" type="button" title="' + self.uploadTitle + '"class="' + css + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</button>';
            } else {
